...
export function ColorEditorTypeSwitch() {
  ...
  return (
    <TabsPrimitive.TabsList aria-label="// TODO" id="color-editor-type-switch" className="xss:grid-cols-2 grid">
      <TabsPrimitive.TabsTrigger className={clsx(className, 'rounded-l-md')} value="hsla">
        HSLA
      </TabsPrimitive.TabsTrigger>
      <TabsPrimitive.TabsTrigger className={clsx(className, 'rounded-r-md')} value="rgba">
        RGBA
      </TabsPrimitive.TabsTrigger>
